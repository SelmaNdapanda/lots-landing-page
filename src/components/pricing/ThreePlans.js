...
export default ({
  ...
  description = "Find out which plan is right for you",  plans = null,
  ...
  const defaultPlans = [
    ...
    },
    {
      ...
      features: ["Tailored Pricing, Tailored to company's needs", "Everything in business", "Dedicated account manager", "Custom security review"],
    },
  ];
