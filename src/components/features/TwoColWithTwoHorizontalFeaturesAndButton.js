...
export default ({
  ...
  description = "We want to be a business building system that helps people and organizations achieve effortless economic success.",
  primaryButtonText = "Learn More",
  primaryButtonUrl = "https://www.lotsinsights.com/",
